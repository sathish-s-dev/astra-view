...
export const Footer = () => {
	...
	return (
		<footer className='pt-10'>
			<div className='max-w-screen-xl mx-auto px-3 dark:text-slate-300 text-slate-600 md:px-8'>
				<div className='justify-between sm:flex'>
					<div className='space-y-4'>
						<Icon className='text-lg' />
						<p className='max-w-md'>
							Embark on this astronomical journey with us and expand your
							horizons.
						</p>
						<ul className='flex flex-wrap items-center gap-4 text-sm sm:text-base'>
							{footerNavs.map((item, idx) => (
								<li
									key={idx}
									className='text-slate-800 dark:text-slate-300 hover:underline hover:text-cyan-400 dark:hover:text-cyan-400 hover:scale-105 duration-150'>
									<a
										key={idx}
										href={item.href}>
										{item.name}
				...
				<div className='mt-4 py-2 border-t md:text-center'>
					<p className='text-sm'>© 2023 BlogPro. All rights reserved.</p>
				</div>
			</div>
		</footer>
	);
